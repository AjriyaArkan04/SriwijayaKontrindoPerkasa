...
export function Hero() {
  ...
  // Detect cursor near viewport edges
  useEffect(() => {
    ...
    const handleMove = (e: MouseEvent) => {
      if (e.clientX < EDGE_ZONE_PX) {
        setNearEdge("left");
      } else if (e.clientX > window.innerWidth - EDGE_ZONE_PX) {
        setNearEdge("right");
      } else {
        setNearEdge(null);
      }
  ...
  const goPrev = () =>
    goTo((activeIndex - 1 + heroSlides.length) % heroSlides.length);
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:items-end lg:gap-6">
          <div className="lg:col-span-8">
            ...
            <p className="mt-7 max-w-lg font-body text-base leading-relaxed text-white/80 drop-shadow-[0_1px_8px_rgba(8,16,38,0.8)] md:text-lg">
              Kontraktor, fabrikasi, dan pengolahan air yang mendukung
              kelancaran usaha Anda, dari toko retail hingga fasilitas pabrik
          ...
          <div className="lg:col-span-4">
            <dl className="grid grid-cols-3 gap-6 border-t border-white/20 pt-6 lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0">
              <div>
