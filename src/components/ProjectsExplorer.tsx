  ...
  return (
    <section id="projects" className="bg-paper py-20 md:py-28 scroll-mt-16 md:scroll-mt-20">
      <div className="container-skp">
        <Reveal>
          <SectionLabel index="05" title="Portofolio Proyek" />
        </Reveal>

        <Reveal delay={0.06} className="max-w-xl">
          <h2 className="mt-6 font-display text-2xl font-800 leading-tight tracking-tight text-navy md:text-3xl">
        ...
        <div className="mt-16 grid grid-cols-1 gap-px border border-line-dark bg-line-dark sm:grid-cols-3">
          <div className="bg-navy p-8 text-center">
            <CountStat value={37} prefix="" label="Proyek Astra Otoparts" />
          </div>
          <div className="bg-navy p-8 text-center">
            <CountStat value={25} prefix="" label="Toko FamilyMart" />
          </div>
          <div className="bg-navy p-8 text-center">
        ...
        <div className="mt-10 grid grid-cols-1 gap-1 border border-line bg-white sm:grid-cols-2 lg:grid-cols-3">
